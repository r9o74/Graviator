...
export const MASS_BOOST_COOLING_TIME = 2.0; // 効果終了後、他者との重力が徐々に回復するまでの時間
...
export const WAVE_FORCE_GRAVITY_MULTIPLIER = 11.0; // 現在の難易度のgravityConstantに対する倍率
...
export const WAVE_MAX_CHARGE = 2; // 重力波の最大発動回数
...
export const CAPTURE_TIME_INVERSION = 0.2;
